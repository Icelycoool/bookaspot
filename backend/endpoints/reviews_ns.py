...
class ReviewListResource(Resource):
    ...
    def post(self):
        ...
        existing_review = Review.query.filter_by(user_id=user_id, amenity_id=data['amenity_id']).first()
        if existing_review:
            return make_response(jsonify({'message': 'You have reviewed this amenity'}), 400)
