...
class Amenity(db.Model):
    ...
    images = db.relationship(
        "Media", back_populates="amenity", cascade="all, delete-orphan"
    )
    category = db.relationship("Category", back_populates="amenities")
    owner = db.relationship("User", back_populates="amenities")
    bookings = db.relationship(
        "Booking", back_populates="amenity", cascade="all, delete-orphan"
    )
    reviews = db.relationship(
        "Review", back_populates="amenity", cascade="all, delete-orphan"
    )
